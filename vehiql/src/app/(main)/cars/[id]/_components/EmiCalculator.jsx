...
function EmiCalculator({ price }) {
  ...
  return (
    <div
      className="w-full max-h-[80vh] overflow-y-auto pr-4 
      ...
      <div className="w-full">
        <div className="space-y-2">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
            <h2 className="text-lg font-inter text-gray-900 mb-2">
              • Vehicle Price
            </h2>
            {/* Price inout */}
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-4 py-2 rounded-md border border-gray-200 bg-white  text-gray-700 dark:text-white focus:outline-none focus:border-gray-900 "
                />
              </div>
              <input
                type="range"
          ...
          {/* Down Payment */}
          <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
            <h2 className="text-lg font-inter  text-gray-900 dark:text-white mb-2">
              • Down Payment
            </h2>
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-8 pr-4 py-2 rounded-md border border-gray-200 bg-white  text-gray-700 focus:outline-none focus:border-gray-900"
                />
              </div>
              <input
                type="range"
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Interest */}
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
              <h2 className="text-lg font-inter text-gray-900 dark:text-white mb-3">
                • Interest Rate
              </h2>
              <div className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-8 pl-2 py-2 rounded-md border border-gray-200 bg-white text-gray-700 focus:outline-none focus:border-gray-900 "
                  />
            ...
            {/* Loan */}
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4">
              <h2 className="text-lg font-inter text-gray-900 mb-3">
                • Loan Term
              </h2>
              <div className="space-y-3">
                <div className="relative">
                  <input
                    ...
                    className="w-full pr-14 pl-2 py-2 rounded-md border border-gray-200 bg-white text-gray-700 focus:outline-none focus:border-gray-900"
                  />
                  <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
